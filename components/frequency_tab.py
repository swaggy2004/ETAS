        ...
        children=[
            imports.dbc.Col(
                dcc.RadioItems(
                    ...
                    className="btn-group btn-group-lg border border-2 border-dark mx-auto",
                ...
                class_name="justify-content-center align-items-center border border-2 border-danger mx-auto"
            )
        ]
    )