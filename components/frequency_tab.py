        ...
        children=[
            imports.dbc.Col(
                dcc.RadioItems(
                    ...
                    className="btn-group btn-group-lg border border-2 border-dark align-items-center justify-content-center",
                ...
                class_name="justify-content-center align-items-center border border-2 border-danger"
            )
        ]
    )